 ...
 * Command line was: qdbusxml2cpp -p OrgFreedesktopNotifications org.freedesktop.Notifications.xml
 *
...
#ifndef ORGFREEDESKTOPNOTIFICATIONS_H_1407587915
#define ORGFREEDESKTOPNOTIFICATIONS_H_1407587915
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<uint> Notify(const QString &app_name, uint replaces_id, const QString &app_icon, const QString &summary, const QString &body, const QStringList &actions, const QVariantMap &hints, int expire_timeout)
    {
        QList<QVariant> argumentList;
